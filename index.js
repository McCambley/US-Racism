...
var buttonLink = document.querySelector('.button-link');
var buttonSource = document.querySelector('.button_source');
var factElement = document.querySelector('.fact');
var sourceElement = document.querySelector('.source');
function renderFact() {
    var factNumber = Math.floor(Math.random() * examples.length);
    // const factNumber = 41;
    var fact = examples[factNumber];
